...
fn decode(data: &mut impl Iterator<Item = u8>) -> Result<Opcode, DecodeError> {
    ...
    Ok(match opcode {
        ...
        0x77 => Opcode::Ld(Slot::AddrRegister(AddrRegister::HL), Slot::r8(Register8::A)),
        0x7b => Opcode::Ld(Slot::r8(Register8::A), Slot::r8(Register8::E)),
        0x7f => Opcode::Ld(Slot::r8(Register8::A), Slot::r8(Register8::A)),
